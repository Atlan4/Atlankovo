...
const USB_DeviceDescriptor CH340_DevDesc =
{
  ...
  0x1A86,   //0x067b,//0x1A86,                 //Vendor id
  0x7523,   //0x2303,//0x7523,                 //Device id
  0x0263,   //0x0300,//0x0263,                 //Release version
  0x01,                   //iManufacturer
  0x02,                   //iProduct
  0x00,                   //ISerial
...
{
  {
    ...
    0x01, //NumInterfaces   //1 bolo origo
  ...
  },
  {
    ...
    0x03, //ep number
    0x02,    //0xFF, //Interface Class
    0x01,    //0x00,//0x01, //Interface Subclass
    0x00,//0x02, //Interface Protocol
